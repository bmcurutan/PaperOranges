...
protocol SortingViewModel {
	var sections: [SortingSection] { get }
...
class BubbleSortViewModel: SortingViewModel {
	var sections: [SortingSection] = [
		SortingSection(type: .speaker),
		SortingSection(type: .buttons),
		SortingSection(type: .steps, title: "Steps"),
	]
	...
	// TODO add UI for "next loop/iteration"
	// TODO3 translate into Italian
	var steps: [Step] = [
